    ...
    <div className="mainDiv">
        <div className="main_nos_container holder">
            <div className="imagenes left">
                <img className="img1" src="img/nos3.jpg" alt="Nosotros_1"/>
                <img className="img2" src="img/nos2.jpg" alt="Nosotros_2"/>
                <img className="img3" src="img/nos1.jpg" alt="Nosotros_3"/>
            </div>
